...
export default function Sidebar() {
	return (
		<aside className="p-8 lg:py-16 lg:pr-16 w-full fixed right-0 lg:right-auto lg:sticky lg:top-0 bottom-0 left-0 z-10 bg-white text-primary capitalize text-xl flex justify-evenly lg:justify-start lg:flex-col gap-8 rounded-md shadow">
			<NavLink
				to={'/dashboard/home'}
